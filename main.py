...
#Loads chrome with default settings from line 6 to 15
opt=Options()
opt.add_argument("start-maximized")   #browser will open in maximised screen
opt.add_argument("--disable-extensions")    #disable any extension present
# Pass the argument 1 to allow and 2 to block (we are allowing the permissions required)
